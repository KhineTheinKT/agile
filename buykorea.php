...
<body>
    ...
    <div class="breadcumb-area bg-img bg-overlay2" style="background-image: url(img/bg-img/ultrakbg.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact-content mb-100">
                        <iframe width="540" height="300" src="https://www.youtube.com/embed/eRQNKx1sM3s" frameborder="0"
                    ...
                    <div class="contact-content mb-100">
                        ...
                        <div class="contact-form-area">
                            <form action="customer.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="ph" placeholder="Ph No.">
                                </div>
                                <div class="form-group">
                                ...
                                <button class="btn musica-btn mt-30" name="userbuyku" type="submit">Buy</button>
                            </form>
                        </div>
                    </div>
                </div>
