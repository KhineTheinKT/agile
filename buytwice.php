...
<body>
    ...
    <div class="breadcumb-area bg-img bg-overlay2" style="background-image: url(img/bg-img/twicebg.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact-content mb-100">
                        <a href="#"><img src="img/bg-img/twicewt.jpg" alt=""></a>
                    ...
                    <div class="contact-content mb-100">
                        ...
                        <div class="contact-form-area">
                            <form action="register.php" method="post">
                                ...
                                <button class="btn musica-btn mt-30" name="usertwice" type="submit">Register</button>
                            </form>
                        </div>
                    </div>
                </div>
